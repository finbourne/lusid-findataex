...
namespace Lusid.FinDataEx.Tests.Vendor
{
    ...
    public class FinDataExTests
    {
        ...
        public void Process_OnValidDlRequestToLptOutput_ShouldReturnIVendorResponseAndWriteToFile()
        {
            ...
            //execute
            _finDataEx.Process(fdeValidRequest);

            //verify
            var outputFile = _tempOutputDir + Path.DirectorySeparatorChar + "DL12345_Prices.csv";
            // ensure written to csv
            Assert.That(outputFile, Does.Exist);
            
            // check contents of csv as expected
            var finData = File.ReadAllLines(outputFile);
        ...
        public void Process_OnValidDlCorpActionsRequestToLptOutput_ShouldReturnIVendorResponseAndWriteToFile()
        {
            ...
            //verify
            var dvdCashCorpActionFile = _tempOutputDir + Path.DirectorySeparatorChar + "DL30001_DVD_CASH.csv";
            var stockSplitCorpActionFile = _tempOutputDir + Path.DirectorySeparatorChar + "DL30001_STOCK_SPLT.csv";
            ...
            var dvdCashFinData = File.ReadAllLines(dvdCashCorpActionFile);
            ...
            Assert.That(
                ...
                Is.EqualTo(dvdCashFinData[6]));
            
            
            // check contents of stock split cash as expected
            var stockSplitFinData = File.ReadAllLines(stockSplitCorpActionFile);
            ...
            // ensure correct headers constructed correctly
            Assert.That(
                "Ticker|CorpActionHeader_1|CorpActionHeader_2|CorpActionHeader_3|CorpActionHeader_4|CorpActionHeader_5|CorpActionHeader_6|CorpActionHeader_7|CorpActionHeader_8|CorpActionHeader_9|CorpActionHeader_10|CorpActionHeader_11|CorpActionHeader_12|CorpActionHeader_13|CorpActionHeader_14|CorpActionHeader_15|CorpActionHeader_16|CorpActionHeader_17|CorpActionHeader_18", 
                Is.EqualTo(stockSplitFinData[0]));
            ...
            Assert.That(
                ...
                Is.EqualTo(stockSplitFinData[1]));
            
            Assert.That(
                "ABC US Equity|STOCK_SPLT|D|ABC Name|CUSIP|123456789|USD|Equity|EQ0010000000000000|07/30/2020|08/31/2020|07/31/2020|BBG0002|BBG001000000|AAPL|US|1|DELETE_REASON|2",
                Is.EqualTo(stockSplitFinData[2]));
            ...
            Assert.That(
                ...
                Is.EqualTo(stockSplitFinData[3]));
        ...
        public void Process_OnUnsupportedVendor_ShouldThrowDataException()
        {
            ...
            //execute
            Assert.Throws<InvalidDataException>(() => _finDataEx.Process(unsupportedVendorFdeRequest),
